...
import { DesktopBlockEditorComponent } from '../src/web/DesktopBlockEditorComponent';

import '@kapeta/ui-web-components/styles/index.less';
import { EntityType, BlockDefinition } from '@kapeta/schemas';
import { FormContainer } from '@kapeta/ui-web-components';

const BLOCK_KIND = 'kapeta/block-type-desktop';
...
export const CreateEditor = () => {
    ...
    return (
        <div style={{ minHeight: '500px' }}>
            ...
            >
                <DesktopBlockEditorComponent creating={true} />
            </FormContainer>
        </div>
    );
};
...
export const EditEditor = () => {
    ...
    return (
        <div style={{ height: '500px' }}>
            ...
            >
                <DesktopBlockEditorComponent creating={false} />
            </FormContainer>
        </div>
    );
};
