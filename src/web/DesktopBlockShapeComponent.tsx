...
export const DesktopBlockShapeComponent = <TBlockType extends BlockDefinition>(
    ...
    return (
        <g className="block-node" style={{ cursor: block.readOnly ? 'default' : 'move' }}>
            ...
            <svg fill="none" x={props.width / 2} y={15} width={props.width - 20} viewBox="0 0 150 150">
                <BlockInstanceName />
            </svg>
            ...
            >
                <path
                    d="M192 165C192 167.761 189.761 170 187 170L5 170C2.23859 170 0 167.761 0 165V144L192 144V165Z"
                    fill="#E0E0E0"
                />
